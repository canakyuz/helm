...
export const COUNTRY_GEO: Record<string, CountryGeo> = {
  ...
  AQ: { name: "Antarctica", lat: -82.8628, lng: 135.0 },
  AR: { name: "Argentina", lat: -38.4161, lng: -63.6167 },
  AS: { name: "American Samoa", lat: -14.27, lng: -170.1322 },
  ...
  CC: { name: "Cocos Islands", lat: -12.1642, lng: 96.871 },
  ...
  CX: { name: "Christmas Island", lat: -10.4475, lng: 105.6904 },
  ...
  EH: { name: "Western Sahara", lat: 24.2155, lng: -12.8858 },
  ...
  GS: { name: "South Georgia", lat: -54.4296, lng: -36.5879 },
  ...
  HM: { name: "Heard and McDonald Islands", lat: -53.0818, lng: 73.5042 },
  ...
  IO: { name: "British Indian Ocean Territory", lat: -6.3432, lng: 71.8765 },
  ...
  KN: { name: "Saint Kitts and Nevis", lat: 17.3578, lng: -62.7829 },
  ...
  KY: { name: "Cayman Islands", lat: 19.5135, lng: -80.5666 },
  ...
  NF: { name: "Norfolk Island", lat: -29.0408, lng: 167.9547 },
  ...
  PG: { name: "Papua New Guinea", lat: -6.315, lng: 143.9555 },
  ...
  PM: { name: "Saint Pierre and Miquelon", lat: 46.9419, lng: -56.2711 },
  PN: { name: "Pitcairn Islands", lat: -24.7036, lng: -127.4393 },
  ...
  TC: { name: "Turks and Caicos Islands", lat: 21.694, lng: -71.7979 },
  TD: { name: "Chad", lat: 15.4542, lng: 18.7322 },
  TF: { name: "French Southern Territories", lat: -49.2804, lng: 69.3486 },
  ...
  WF: { name: "Wallis and Futuna", lat: -13.7687, lng: -177.1562 },
