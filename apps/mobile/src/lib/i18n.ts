...
const EN: Record<string, string> = {
  ...
  // Sosyal - kutuphane, kuyruk, paylasim
  "Sosyal": "Social",
  "Kütüphane": "Library",
  "Kuyruk": "Queue",
  "Hesaplar": "Accounts",
  ...
  "Yayında": "Live",
  "Kısmen yayında": "Partly live",
  "Hata": "Failed",
  "İptal edildi": "Cancelled",
  "Bekliyor": "Pending",
  "{n} sn": "{n}s",
  "Kütüphanede olmayan içerik": "Content not in library",
  "yeniden bağla": "reconnect",
  "Kopyala": "Copy",
  "Metin yok": "No text",
  "{n} takipçi": "{n} followers",
  "30 günde {n} gösterim": "{n} impressions in 30 days",
  "Hepsini planla": "Schedule all",
  "{n} video her gün 20:00'de birer birer planlanacak. İlki en erken yarın.":
    "{n} videos will be scheduled one per day at 20:00. The first goes out tomorrow at the earliest.",
  "Planla": "Schedule",
  "{n} video · {m} hazır": "{n} videos · {m} ready",
  "Paylaşım durumları okunamadı: {e}": "Could not read post statuses: {e}",
  "Kütüphane yükleniyor": "Loading library",
  "Kütüphane boş. Videoları scripts/social/import-library.ts ile içe aktar.":
    "Library is empty. Import videos with scripts/social/import-library.ts.",
  "Yayınlanan": "Published",
  "Hatalı": "Failed",
  "Planı iptal et": "Cancel schedule",
  "Bu paylaşım Zernio'dan silinecek.": "This post will be removed from Zernio.",
  "İptal et": "Cancel post",
  "Kuyruk yükleniyor": "Loading queue",
  "Kuyruk boş. Kütüphaneden bir video paylaş ya da planla.":
    "Queue is empty. Share or schedule a video from the library.",
  "Hesaplar yükleniyor": "Loading accounts",
  "Bağlı sosyal hesap yok - web'den Zernio'yu bağla": "No social accounts - connect Zernio on the web",
  "İÇERİK": "CONTENT",
  "Paylaşım": "Post",
  "İçerik yükleniyor": "Loading content",
  "İçerik bulunamadı. Kütüphaneye dön ve listeyi yenile.":
    "Content not found. Go back to the library and refresh.",
  "Paylaşım durumu yükleniyor": "Loading post status",
  "Sabit yorum": "Pinned comment",
  "Videoyu aç": "Open video",
  "Videoyu aç ›": "Open video ›",
  "Durum": "Status",
  "Aç ›": "Open ›",
  "Şimdi paylaş": "Share now",
  "{p} için yaklaşık 2 dakika içinde yayınlanacak.": "Goes live on {p} in about 2 minutes.",
  "Paylaş": "Share",
  "Geçmiş bir zaman seçilemez": "Pick a time in the future",
  "Son deneme başarısız: {e}": "Last attempt failed: {e}",
  "bilinmeyen hata": "unknown error",
  "En az bir platform seç.": "Select at least one platform.",
  "Tarih ve saat": "Date and time",
  "{d} için planla": "Schedule for {d}",
  "Bugün 20:00": "Today 20:00",
  "Yarın 20:00": "Tomorrow 20:00",
  "Paylaşım sıraya alındı": "Post queued",
  "Planlandı": "Scheduled",
  "Paylaşılamadı": "Could not share",
  "{n} video planlandı": "{n} videos scheduled",
  "Planlanamadı": "Could not schedule",
  "Plan iptal edildi": "Schedule cancelled",
  "İptal edilemedi": "Could not cancel",
  "Yenilenemedi": "Could not refresh",
