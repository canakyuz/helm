...
export default function TabsLayout() {
  ...
  return (
    ...
    // minimizeBehavior (iOS 26+): asagi kaydirinca bar kuculur, uzun ekranlarda
    // (Ozet, Gelir) icerige yer acar; eski iOS'ta etkisiz.
    <NativeTabs
    ...
    >
      ...
      <NativeTabs.Trigger name="social">
        ...
        <NativeTabs.Trigger.Label>{t("Sosyal")}</NativeTabs.Trigger.Label>
      </NativeTabs.Trigger>
